                        ...
                        <div class="lg:ms-24">
                            <div data-fc-type="accordion" data-aos="fade-up" data-aos-duration="500">
                                ...
                                <button
                                    ...
                                    <h1 class="font-medium mb-4 mt-2">Lorem</h1>
                                </button>
                                <div class="w-full overflow-hidden duration-300 ps-16">
                                    <p class="text-gray-700 dark:text-gray-300">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, reiciendis! Deleniti quaerat, libero sint voluptas aperiam neque doloribus numquam, odit dolorum cumque dicta sequi cum!
                                    </p>
                                </div>
                                ...
                                <div class="hidden w-full overflow-hidden duration-300 ps-16">
                                    <p class="text-gray-700 dark:text-gray-300">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis, at! Iusto placeat nobis eveniet voluptates, porro ratione? Unde soluta voluptatum provident, vel error, facere neque dolore, fugiat delectus officia totam.
                                    </p>
                                </div>
                                ...
                                <div class="hidden w-full overflow-hidden duration-300 ps-16">
                                    <p class="text-gray-700 dark:text-gray-300">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. In ducimus praesentium cupiditate, aliquid deleniti ipsum vitae eaque? Obcaecati quo voluptatem velit perspiciatis recusandae eaque, aperiam, fuga debitis provident modi consequatur?
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div id="aboutus">
                    <div class="grid lg:grid-cols-2 grid-cols-1n gap-6 items-center">
                        <div class="order-2 lg:order-1 2xl:w-9/12" data-aos="fade-up" data-aos-duration="500">
                            <h1 class="text-3xl font-bold mt-6 mb-4 text-center text-biru">About Us</h1>
